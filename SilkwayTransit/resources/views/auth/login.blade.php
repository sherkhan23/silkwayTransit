    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content rounded-4 shadow">
            ...
            <div class="modal-body p-5 pt-0">
                ...
                <form action="{{ route("login_process") }}" class="space-y-5" method="POST">
                    @csrf
                    ...
                    <div>
                        <a href="{{ route("register") }}" class="font-medium text-secondary rounded-md p-2">Нет аккаунта?</a>
                    </div>

                    <button type="submit" class="btn btn-outline-primary text-center w-full py-3 font-medium" style="font-size: 20px">Войти</button>
                </form>
            </div>
        </div>
    </div>
